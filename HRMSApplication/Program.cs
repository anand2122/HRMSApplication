...
builder.Services.AddSingleton<IDepartmentService>(new DepartmentService(cosmosClient, cosmosDatabaseName, cosmosContainerName));

builder.Services.AddScoped<IUnitOfWork, UnitOfWork>();
builder.Services.AddScoped<IEmployeeBizLayer, EmployeeBizLayer>();


builder.Services.AddSingleton<DepartmentContext>();
